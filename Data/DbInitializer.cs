...
namespace LibraryManager
{
    public class DbInitializer
    {
        private static void InitializeBookDb(AppDbContext dbContext)
        {
            var books = new[]
            {
                new Book { Title = "1984", Author = "George Orwell", Genre = "Dystopian", BorrowedByUserId = 1 },
                ...
                new Book { Title = "Fahrenheit 451", Author = "Ray Bradbury", Genre = "Dystopian" , BorrowedByUserId = 1},
                new Book { Title = "We", Author = "Yevgeny Zamyatin", Genre = "Dystopian" },

                new Book { Title = "The Hobbit", Author = "J.R.R. Tolkien", Genre = "Fantasy" },
                new Book { Title = "The Lord of the Rings", Author = "J.R.R. Tolkien", Genre = "Fantasy" , BorrowedByUserId = 1},
                ...
                new Book { Title = "The Brothers Karamazov", Author = "Fyodor Dostoevsky", Genre = "Classic" , BorrowedByUserId = 1},
                ...
                new Book { Title = "The Count of Monte Cristo", Author = "Alexandre Dumas", Genre = "Classic" , BorrowedByUserId = 1},
                ...
                new Book { Title = "Foundation and Empire", Author = "Isaac Asimov", Genre = "Science Fiction" , BorrowedByUserId = 1},
                ...
                new Book { Title = "The Great Gatsby", Author = "F. Scott Fitzgerald", Genre = "Literary Fiction" , BorrowedByUserId = 1},
                new Book { Title = "Moby-Dick", Author = "Herman Melville", Genre = "Literary Fiction" },
                new Book { Title = "Jane Eyre", Author = "Charlotte Brontë", Genre = "Literary Fiction"  , BorrowedByUserId = 3},
                ...
                new Book { Title = "The Silence of the Lambs", Author = "Thomas Harris", Genre = "Thriller" , BorrowedByUserId = 1},

                new Book { Title = "The Shining", Author = "Stephen King", Genre = "Horror" , BorrowedByUserId = 3 },
                ...
                new Book { Title = "Frankenstein", Author = "Mary Shelley", Genre = "Horror" , BorrowedByUserId = 1},
                ...
                new Book { Title = "Journey to the Center of the Earth", Author = "Jules Verne", Genre = "Adventure" , BorrowedByUserId = 1},

                new Book { Title = "The Martian", Author = "Andy Weir", Genre = "Science Fiction" , BorrowedByUserId = 3},
                new Book { Title = "Project Hail Mary", Author = "Andy Weir", Genre = "Science Fiction" },
                new Book { Title = "Ready Player One", Author = "Ernest Cline", Genre = "Science Fiction" , BorrowedByUserId = 1}
            };
