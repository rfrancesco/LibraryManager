...
- Each book is a single item. Multiple copies of the same book correspond to multiple records. This is just to simplify the design. To handle this case, a new table with each copy could be used, with foreign key BookId.
